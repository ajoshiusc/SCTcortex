...
% DO NOT CALL REDUCEPATCH!! It GIVES RANDOM RESULT
%tar=reducepatch(tar_orig,10000);
...
%%%
%cohortSizeAbnormal = 50
%SCT_hist_grp1 = SCT_hist_grp1 (:,1:cohortSizeAbnormal,:);
...
for nb=1:20
    ...
    %
    'saving ...'
    save results_simulation_hist_kernel_conc1p5_dim2.mat
    'save done.'
end

show_surf_val(tarsm, var (pValUnpermuted_boot, [], 2), [0,0.3], cmap);
%pause, export_fig -a1 -m2 -transparent Pics/Var_Hist_RiemannianKPCA_SCT.png, close

show_surf_val(tarsm, (0.1-pValUnpermuted_boot (:,1)), [0,0.1], cmap);
%pause, export_fig -a1 -m2 -transparent Pics/Hist_RiemannianKPCA_SCT.png, close
