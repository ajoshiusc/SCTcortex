...
% [ t2unpermuted t2permuted_all ] = permutation_test (SCT_hist_grp1, SCT_hist_grp2, numOfPermutations);
for nb=1:20
    if nb==1
        [ t2unpermuted t2permuted_all ] = permutation_test(SCT_hist_grp1, SCT_hist_grp2, numOfPermutations);
    else
        [ t2unpermuted t2permuted_all ] = permutation_test(datasample(SCT_hist_grp1,size(SCT_hist_grp1,2),2), datasample(SCT_hist_grp2,size(SCT_hist_grp2,2),2), numOfPermutations);
    end
    outlierRemovalPrctile = 97
    [ pValUnpermuted1 t2PermutedExtreme ] = permutation_test_p_values (t2unpermuted, t2permuted_all, outlierRemovalPrctile);
    pValUnpermuted(nb,:)=pValUnpermuted1;
    fprintf('nb=%d/20',nb);
end
show_surf_val(tarsm,(var(pValUnpermuted,1)),[0,.3],cmap);
export_fig -a1 -m2 -transparent Pics/bootstrap_sim_SCT_right_nonRiemannian.png, close
% see p values
show_surf_val(tarsm,(pValUnpermuted),[0,1],cmap);
...
export_fig -a1 -m2 -transparent Pics/results_oasis_sim_SCT_right_nonRiemannian.png, close
[false_pos_rate,true_pos_rate]=roc_pval(pValUnpermuted,grnd_truth,1000);
figure;plot(false_pos_rate,true_pos_rate)
export_fig -a1 -m2 -transparent Pics/ROC_sim_SCT_hist_right_nonRiemannian.png, close
...
% [ S_t2unpermuted S_t2permuted_all ] = permutation_test (S_hist_grp1_noisy(:,1:min(end,numOfSubSelected),:), S_hist_grp2_noisy(:,1:min(end,numOfSubSelected),:), numOfPermutations);
...
export_fig -a1 -m2 -transparent Pics/results_oasis_sim_S_right_nonRiemannian.png, close
[false_pos_rate,true_pos_rate]=roc_pval(S_pValUnpermuted,grnd_truth,1000);
figure;plot(false_pos_rate,true_pos_rate)
export_fig -a1 -m2 -transparent Pics/ROC_sim_S_hist_right_nonRiemannian.png, close
...
% [ C_t2unpermuted C_t2permuted_all ] = permutation_test (C_hist_grp1, C_hist_grp2, numOfPermutations);
[ C_t2unpermuted C_t2permuted_all ] = permutation_test (C_hist_grp1, C_hist_grp2, numOfPermutations);
outlierRemovalPrctile = 97
...
export_fig -a1 -m2 -transparent Pics/results_oasis_sim_C_right_nonRiemannian.png, close
[false_pos_rate,true_pos_rate]=roc_pval(C_pValUnpermuted,grnd_truth,1000);
figure;plot(false_pos_rate,true_pos_rate)
export_fig -a1 -m2 -transparent Pics/ROC_sim_C_hist_right_nonRiemannian.png, close
...
export_fig -a1 -m2-transparent  Pics/results_oasis_sim_T_right_nonRiemannian.png, close
[false_pos_rate,true_pos_rate]=roc_pval(T_pValUnpermuted,grnd_truth,1000);
figure;plot(false_pos_rate,true_pos_rate)
export_fig -a1 -m2 -transparent Pics/ROC_sim_T_hist_right_nonRiemannian.png, close
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % SC histogram only
...
% % [ SC_t2unpermuted SC_t2permuted_all ] = permutation_test (SC_hist_grp1, SC_hist_grp2, numOfPermutations);
% [ SC_t2unpermuted SC_t2permuted_all ] = permutation_test(SC_hist_grp1, SC_hist_grp2, numOfPermutations);
% outlierRemovalPrctile = 97
...
% export_fig -a1 -m2 -transparent Pics/results_oasis_sim_SC_right_nonRiemannian.png
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % ST histogram only
...
% % [ ST_t2unpermuted ST_t2permuted_all ] = permutation_test (ST_hist_grp1, ST_hist_grp2, numOfPermutations);
% [ ST_t2unpermuted ST_t2permuted_all ] = permutation_test(ST_hist_grp1, ST_hist_grp2, numOfPermutations);
% outlierRemovalPrctile = 97
...
% export_fig -a1 -m2-transparent Pics/results_oasis_sim_ST_right_nonRiemannian.png
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % CT histogram only
...
% % [ CT_t2unpermuted CT_t2permuted_all ] = permutation_test (CT_hist_grp1, CT_hist_grp2, numOfPermutations);
% [ CT_t2unpermuted CT_t2permuted_all ] = permutation_test(CT_hist_grp1, CT_hist_grp2, numOfPermutations);
% outlierRemovalPrctile = 97
...
% export_fig -a1 -m2 -transparent Pics/results_oasis_sim_CT_right_nonRiemannian.png, close
% 
% save ( 'results_simulation_0.1_right_nonRiemannian.mat');
