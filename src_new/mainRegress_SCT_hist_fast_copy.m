...
for nb = 1 : 20
    ...
    %
    save ('sct_hist_testStats_left_all_nonlinear.mat', ...
...
%
show_surf_val(tarsm, pv, [0,0.05], cmap); colorbar off;
pause, export_fig -a1 -m2 -transparent Pics/HCPregress_Hist_Nonlinear_SCT_R.png, close
show_surf_val(tarsm, var(pValUnpermuted_Ftest_all_boot,[],2), [0,0.3], cmap); colorbar off;
pause, export_fig -a1 -m2 -transparent Pics/HCPregress_Var_Hist_Nonlinear_SCT_R.png, close
