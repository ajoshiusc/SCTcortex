...
for nb = 1:20
    ...
    [ testStatsUnpermuted_all, ...
        ...
        = permutation_test_hist_regression_all2 ...
    ...
    %
    save ('sct_hist_simulation_testStats_right_all_nonlinear_new.mat', ...
...
thresh = 0.1
%
pp (:,1) = (pValUnpermuted_Ftest_all'         <thresh).*(thresh-pValUnpermuted_Ftest_all');
...
for testNum = 1 : 1 % 5
    ...
    % pause, close
    % export_fig -a1 -m2 -transparent Pics/Hist_RiemannianKernel_SCT.png, close
end
figure;
