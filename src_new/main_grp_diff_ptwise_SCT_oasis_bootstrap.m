...
for nb=1:20
    if nb==1
        ...
        [ t2unpermuted t2permuted_all ] = permutation_test(datasample(SCTgrp1,size(SCTgrp1,2),2), datasample(SCTgrp2,size(SCTgrp2,2),2), numOfPermutations);
    end
...
export_fig -a1 -m2 -transparent Pics/results_oasis_SCT_left_hemi.png, close
