function [ testStatsUnpermuted_all, ...
    ...
    = permutation_test_hist_regression_all2 (histsSqrtCrossExp_all, hists, cogScore, numOfPermutations)
...
parfor permNum = 1 : numOfPermutations + 1
    ...
    [ testStats_all ] = hypothesis_test_hist_regression_all2 (histsSqrtCrossExp_all, hists, cogScorePerm);
    % save
